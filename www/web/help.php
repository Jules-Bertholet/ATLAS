        ...
        <div class="col-sm-5">
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <p class="text-muted"><i> &#916G (kcal mol<sup>-1</sup>) < -6.00</i> </p> </li> <li
    ...
    <div class="container">
        ...
        <div class="col-sm-5">
            ...
            <ul class="list-group">
                <li class="list-group-item">
                    <img src="help/1.png" width="40" align="left" hspace="15">
                    <p> The <i class="text-muted">PDB</i> column refers to the Protein Data Bank (PDB) ID for a
                        structure
                ...
                <li class="list-group-item">
                    ...
                    <p>The <i class="text-muted">Template PDB</i> column refers to the PDB ID for a template structure
                        ...
                        The <i class="text-muted">TCR mutation chain </i> and <i class="text-muted">MHC mutation
                            chain</i> refer
                        to the protein chain (A for alpha and B for beta) carrying the TCR and MHC mutations,
                        respectively.
                    </p>
                </li>
            </ul>

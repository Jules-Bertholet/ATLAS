                                ...
                                pv.io.fetchPdb(pdbfile, function (structure) {
                                    ...
                                    if (pep_mut[0] != "WT") {
                                        for (i = 0; i < pep_mut.length; i++) {
                                            ...
                                            var mutant = structure.select({
                                                cname: 'C',
                                                rnum: parseInt(res_num)
                                            });
            ...
            <div class="col-sm-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <br></br>
                        <p> Designed model of <?php echo $_GET['pdb'] ?> with the following mutation(s):
                            <p>
                                <ul class="list-group">
                                    <?php
                            if ($_GET['tcr_mut'] == 'WT') {
                                ...
                                ?> <li class="list-group-item">TCR mutations: <?php echo $_GET['tcr_mut']; ?>
                                    </li>
                                    <li class="list-group-item">TCR mutation chains: <?php echo $_GET['tcr_chain']; ?>
                                    </li>
                                    <?php
                            }
                            if ($_GET['mhc_mut'] == 'WT') {
                                ...
                                ?><li class="list-group-item">MHC mutations: <?php echo $_GET['mhc_mut']; ?>
                                    </li>
                                    <li class="list-group-item">MHC mutation chains: <?php echo $_GET['mhc_chain']; ?>
                                    </li>
                                    <?php
                            }
                            if ($_GET['pep_mut'] == 'WT') {
                                ...
                                ?><li class="list-group-item">Peptide mutations:
                                        <?php echo $_GET['pep_mut']; ?></li>
                                    <?php
                            } ?>
                                </ul>
